...
class Hello(object):
    ...
    <form method=POST action=spur>
    齒數:<input type=text name=K><br />
    模數:<input type=text name=N><br />
    壓力角:<input type=text name=inp2><br />
    <input type=\"submit\" value=\"確定\">
    <input type=\"reset\" value=\"重填\">
    </form>

    <legend>第三題:</legend>
    <form method=POST action=drewspur>
    齒數:<input type=text name=K><br />
    模數:<input type=text name=N><br />
    壓力角:<input type=text name=inp2><br />
    <input type=\"submit\" value=\"確定\">
...
<canvas id="plotarea" width="800" height="800"></canvas>
    ...
    <input type=submit value=send>
        ...
        return outstring
    #@+node:2015.20150428110751.1752: *3* index1
    @cherrypy.expose
    def index1(self, K=None, N=None, inp2=None):
        # 將標準答案存入 answer session 對應區
        theanswer = random.randint(1, 100)
        thecount = 0
        # 將答案與計算次數變數存進 session 對應變數
    ...
    '''
        return outstring
    #@+node:2015.20150428110751.1754: *3* spur
    @cherrypy.expose
    ...
    '''
        return outstring
    #@+node:2015.20150428110751.1835: *3* drewspur
    @cherrypy.expose
    def drewspur(self, K=None, N=None, inp2=None):
        # 將標準答案存入 answer session 對應區
        theanswer = random.randint(1, 100)
        thecount = 0
        # 將答案與計算次數變數存進 session 對應變數
